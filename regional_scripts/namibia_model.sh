...
#     --write_dir /gws/ssde/j25b/ceh_generic/kgoldmann/classifier_data/gbif_namibia/ \
#     --species_list /home/users/katriona/gbif_download_standalone/species_checklists/final/namibia-moths-keys-nodup.csv \
#     --train_ratio 0.75 \
#     --val_ratio 0.10 \
#     --test_ratio 0.15 \
...
#     --train_split_file /gws/ssde/j25b/ceh_generic/kgoldmann/classifier_data/gbif_namibia/01_namibia_data-train-split.csv
...
# do
#     echo '--' $VARIABLE
#     mkdir -p /gws/ssde/j25b/ceh_generic/kgoldmann/classifier_data/gbif_namibia/$VARIABLE
#     python 03_create_webdataset.py \
#         --dataset_dir /gws/ssde/j25b/ceh_generic/kgoldmann/gbif_images/ \
#         --dataset_filepath /gws/ssde/j25b/ceh_generic/kgoldmann/classifier_data/gbif_namibia/01_namibia_data-$VARIABLE-split.csv \
#         --label_filepath /gws/ssde/j25b/ceh_generic/kgoldmann/classifier_data/gbif_namibia/01_namibia_data_numeric_labels.json \
#         --image_resize 500 \
#         --max_shard_size 100000000 \
#         --webdataset_pattern "/gws/ssde/j25b/ceh_generic/kgoldmann/classifier_data/gbif_namibia/$VARIABLE/$VARIABLE-500-%06d.tar"
# done
...
# 4. Train the model
generate_file_range() {
    local directory="/gws/ssde/j25b/ceh_generic/kgoldmann/classifier_data/gbif_namibia/"
    local prefix="$1"
