...
About         : returns macro accuracy of a batch for different taxon levels for
different top 'n' accuracies
"""
...
class MacroAccuracyBatch:
    ...
    def batch_accuracy(self):
        ...
        genus_predict_indx_3 = self.genus_to_label_pr(
            self.species_to_genus_pr(self.label_to_spname_pr(predict_indx_3))
        )
        genus_predict_indx_10 = self.genus_to_label_pr(
            self.species_to_genus_pr(self.label_to_spname_pr(predict_indx_10))
        )
        ...
        family_labels = self.family_to_label_gt(
            self.species_to_family_gt(self.label_to_spname_gt())
        )
        family_predict_indx_1 = self.family_to_label_pr(
            self.species_to_family_pr(self.label_to_spname_pr(predict_indx_1))
        )
        family_predict_indx_3 = self.family_to_label_pr(
            self.species_to_family_pr(self.label_to_spname_pr(predict_indx_3))
        )
        family_predict_indx_10 = self.family_to_label_pr(
            self.species_to_family_pr(self.label_to_spname_pr(predict_indx_10))
        )
