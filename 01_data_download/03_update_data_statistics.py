...
def update_data_statistics(args):
    ...
    if not os.path.exists(args.data_directory + "data_statistics.csv"):
        with open(args.data_directory + "data_statistics.csv", mode='w', encoding='utf-8') as f:
    ...
    for _, row in species_list.iterrows():
        ...
        taxon_key = row["taxon_key_gbif_id"]
