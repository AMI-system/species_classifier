...
class MOTHDataset(Dataset):
    def __init__(self, root_dir, data_list, label_list, transform=None):
        ...
        Args:
                ...
                data_list (string) : Contains the list of data points for a
                particular set (train/val/test)
                label_list (string): path to file that contains the list of labels
                for conversion to numerics
