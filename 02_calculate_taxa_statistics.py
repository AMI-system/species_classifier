...
def taxon_hierarchy(args):
    ...
    for indx in data.index:
        if (
            data["gbif_species_name"][indx] not in taxon_hierar.keys()
            and data["gbif_species_name"][indx] != "NA"
        ):
            taxon_hierar[data["gbif_species_name"][indx]] = [
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--species_list", help="path to the species list", required=True
    )
    parser.add_argument(
        "--write_dir",
